...
interface PGLUtessellatorCallback {
     ...
     * identical to the opaque reference provided when [ ][PGLU.gluTessBeginPolygon] was called.
     *
     * @param type
     * Specifics the type of begin/end pair being defined.  The following
     * values are valid:  **GL_TRIANGLE_FAN**, **GL_TRIANGLE_STRIP**,
     ...
     * [gluTessBeginPolygon][PGLU.gluTessBeginPolygon] was called.
     *
     * @param boundaryEdge
     * Specifics which edges lie on the polygon boundary.
     * @param polygonData
     ...
     * provided by the user when the vertex was described (see [ ][PGLU.gluTessVertex]).
     *
     * @param vertexData
     ...
     * [gluTessEndPolygon][PGLU.gluTessEndPolygon] is
     * called.</P><P>
     *
     ...
     */
    fun combine(coords: DoubleArray?, data: Array<Any?>?,
     ...
     * @see .combine combine
     */
    fun combineData(coords: DoubleArray?, data: Array<Any?>?,
                    weight: FloatArray?, outData: Array<Any?>?,
                    polygonData: Any?)
     ...
     * [gluErrorString][PGLU.gluErrorString] call.<P>
     *
     ...
     * @see .error error
     */
    fun errorData(errnum: Int, polygonData: Any?) //void mesh(jogamp.opengl.tessellator.GLUmesh mesh);
}