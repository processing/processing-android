 ...
 * [GLUtessellatorCallback][PGLUtessellatorCallback]
 ...
 * @author Processing integration: Andres Colubri, February 2012 and Aditya Rana, July 2020
 */
internal open class PGLUtessellatorCallbackAdapter : PGLUtessellatorCallback {
    ...
    override fun combine(coords: DoubleArray?, data: Array<Any?>?,
                         weight: FloatArray?, outData: Array<Any?>?) {
    }

    override fun beginData(type: Int, polygonData: Any?) {}

    override fun edgeFlagData(boundaryEdge: Boolean,
                              polygonData: Any?) {
    }
    ...
    override fun combineData(coords: DoubleArray?, data: Array<Any?>?,
                             weight: FloatArray?, outData: Array<Any?>?,
                             polygonData: Any?) {
    }
}